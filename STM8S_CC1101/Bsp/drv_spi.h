...
#define spi_nss_rev()                           GPIO_WriteReverse( SPI_NSS_GPIO_PORT, SPI_NSS_GPIO_PIN )
...
#define spi_get_miso( )				( 0 == GPIO_ReadInputPin( SPI_MISO_GPIO_PORT, SPI_MISO_GPIO_PIN )) ? 0 : 1 // 读取输入状态
